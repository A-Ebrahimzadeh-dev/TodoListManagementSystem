...
namespace TodoListManagementSystem.Application.Usecases.TaskItem.Commands.ChangePriorityLevel
{
    public class ChangePriorityLevelCommandHandler(
        ...
        ITodoListRepository todoListRepository) : IRequestHandler<ChangePriorityLevelCommand, TaskItemDto>
    {
        ...
        private async Task<Domain.Entities.TaskItem> ValidateAccessAsync(ChangePriorityLevelCommand request, CancellationToken ct)
        {
